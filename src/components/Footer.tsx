    ...
    <footer className="bg-primary text-white pt-12 pb-6">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="text-2xl font-bold mb-6">РемонтТех</h3>
            <p className="mb-6">
              Профессиональный ремонт бытовой техники в Алматы с выездом на дом.
              Работаем с 2014 года.
            </p>
            <div className="flex space-x-4">
              {/* Социальные сети (иконки только для примера) */}
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="hover:text-secondary transition-colors">Ремонт холодильников</a></li>
              <li><a href="#" className="hover:text-secondary transition-colors">Ремонт стиральных машин</a></li>
              <li><a href="#" className="hover:text-secondary transition-colors">Ремонт посудомоечных машин</a></li>
              <li><a href="#" className="hover:text-secondary transition-colors">Ремонт микроволновых печей</a></li>
              <li><a href="#" className="hover:text-secondary transition-colors">Ремонт телевизоров</a></li>
              <li><a href="#" className="hover:text-secondary transition-colors">Ремонт кофемашин</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#team" className="hover:text-secondary transition-colors">Команда</a></li>
              <li><a href="#testimonials" className="hover:text-secondary transition-colors">Отзывы</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span>Алматы, ул. Байзакова, 222</span>
              </li>
              <li className="flex items-start">
              ...
              <li className="flex items-start">
                ...
                <span>info@mail.kz</span>
              </li>
              <li className="flex items-start">
                <Clock className="h-5 w-5 mr-3 mt-0.5 text-secondary" />
                <span>8:00 – 21:00 ежедневно</span>
              </li>
              <li className="mt-4">
                <a 
        ...
        <div className="pt-8 border-t border-white/20 text-center text-sm text-white/70">
          <p>© {currentYear} РемонтТех. Все права защищены.</p>
        </div>
      </div>
    </footer>
  );
